export const ApplicationName = 'Orenpay';
...
export const ChangePasswordActions = {
  ChangePasswordCallback: 'changepassword-callback',
...
let applicationPaths: ApplicationPathsType = {
  ...
  ChangePassword:`authentication/${ChangePasswordActions.ChangePassword}`,
  ...
  RenewCallback: `renew-callback.html`,
  LoginPathComponents: [],
